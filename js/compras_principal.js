const renderProductosCarrito = () => {
    ...
    if (totalCarrito() > 0) {    
        ...
        <tbody>
        <tr>
        <td colspan="6" class="text-center"><a href="#" class="btn btn-danger" onClick="vaciarCarrito()">Vaciar Carrito <img src="../../images/tacho.png" alt="Vaciar Carrito" width="34" /></a></td>
        </tr>`;
